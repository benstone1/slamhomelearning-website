...
const platforms = [
  { 
    ...
    url: 'https://open.spotify.com/show/0347598USjVejZUHlzQ8Tv' 
  },
  { 
    name: 'YouTube', 
    detail: 'Watch the video podcast', 
    url: 'https://www.youtube.com/@SLAMhomelearning/podcasts' 
  },
  { 
    name: 'Apple Podcasts', 
    detail: 'Listen on Apple Podcasts', 
    url: 'https://podcasts.apple.com/us/podcast/from-classroom-to-home/id6801576297' 
  }
];
...
const episodes = [
  {
    ...
    youtubeUrl: 'https://m.youtube.com/watch?v=uB2FPQjD3Pw&ra=m'
  },
  {
    number: '01',
    ...
    youtubeUrl: 'https://m.youtube.com/watch?v=ZHWyK8Tt9ng&ra=m'
  },
  {
    number: '02',
    ...
    <main className="min-h-screen bg-gradient-to-b from-sky-50 via-white to-emerald-50 text-gray-900">
      <section className="relative overflow-hidden border-b border-gray-200 bg-white/75">
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-12 sm:px-6 md:grid-cols-[1.2fr_0.8fr] md:py-20">
          ...
          >
            <p className="mb-4 text-sm font-bold uppercase tracking-[0.22em] text-sky-600">
              A SLAM podcast
            </p>
          ...
          >
            <img 
              src="/images/Podcast%20Backpack%20Image.png" 
              alt="Backpack with books and snacks for learning at home" 
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16">
        <motion.div 
          ...
          className="mb-12"
        >
          <h2 className="mb-5 text-3xl font-bold text-sky-700">
            About From Classroom to Home
          </h2>
          <p className="text-lg leading-relaxed text-gray-700">
            From Classroom to Home is a SLAM podcast for parents of children in kindergarten through second grade.
          </p>
          <p className="mt-5 text-lg leading-relaxed text-gray-700">
            In each episode, I talk with an expert guest about an important part of your child&apos;s school experience. Together, we&apos;ll explore what is happening in the classroom and share practical ideas for supporting learning at home.
          </p>
        </motion.div>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {platforms.map((platform) => (
              <a 
                ...
                className="flex items-center justify-between gap-4 border border-gray-200 bg-white p-4 shadow-sm transition-all hover:shadow-md hover:border-sky-300 cursor-pointer"
              >
                <div>
        ...
        <div>
          ...
          <h2 className="mb-7 text-3xl font-bold text-gray-900">
            Conversations to support learning at home
          </h2>
          <div className="space-y-5">
            {episodes.map((episode) => (
              <motion.article 
                ...
                className="border border-gray-200 bg-white p-6 shadow-md sm:p-8"
              >
                  ...
                  <div>
                    ...
                    {episode.youtubeUrl ? (
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer" 
                        className="mt-5 inline-block border border-sky-600 px-4 py-2 font-bold text-sky-700 transition-colors hover:bg-sky-600 hover:text-white"
                      >
                        Watch on YouTube
                      </a>
                    ) : (
                      <p className="mt-5 inline-block border border-gray-300 px-4 py-2 font-bold text-gray-500">
                        Coming soon
                      </p>
                    )}
                  </div>
